...
crt0.o: crt0.s platformer.chr MUSIC/DMCmusic.s MUSIC/DMCmusic.dmc
	$(CA65) crt0.s

$(NAME).o: $(NAME).s
	$(CA65) $(NAME).s -g

$(NAME).s: $(NAME).c Sprites.h platformer4.h BG/Room1.c BG/Room2.c BG/Room3.c BG/Room4.c BG/Room5.c
