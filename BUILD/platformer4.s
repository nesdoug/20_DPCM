...
;
	jmp     L05FC
L07B3:	sta     _BoxGuy1+4
	stx     _BoxGuy1+4+1
;
; BoxGuy1.x += BoxGuy1.vel_x;
;
L05FC:	lda     _BoxGuy1+4
	clc
	adc     _BoxGuy1
	sta     _BoxGuy1
	lda     _BoxGuy1+4+1
...
;
	...
	sec
	sbc     _eject_R
L07B8:	sta     _BoxGuy1+1
;
; if(BoxGuy1.vel_y < 0x300){
;
L0626:	lda     _BoxGuy1+6
	cmp     #$00
	lda     _BoxGuy1+6+1
	sbc     #$03
	bvc     L0630
